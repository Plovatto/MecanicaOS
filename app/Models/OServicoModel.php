...
class OServicoModel extends Model
{
    ...
    public function getServicosForOrdem($ordemdeservico_id)
    {
        return $this->db->table('ordemdeservico_servico')
                ->select('ordemdeservico_servico.*, servicos.nome, servicos.valor as servico_valor,servicos.id as servico_id, servicos.codigo as servico_codigo ,servicos.descricao as servico_descricao , servicos.status as servico_status')

...
class OsPecaModel extends Model
{
    ...
    public function getPecasForOrdem($ordemdeservico_id)
    {
        ...
        ->select('ordemdeservico_peca.*, peca.nome, peca.valor as peca_valor, peca.id as peca_id, peca.codigo as peca_codigo, peca.descricao as peca_descricao, peca.status as peca_status')                ->join('peca', 'peca.id = ordemdeservico_peca.peca_id')
